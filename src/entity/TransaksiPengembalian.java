 ...
 */
public class TransaksiPengembalian implements Entity {
    ...
    public TransaksiPengembalian(String nama_peminjam, String kelas, TransaksiStatus status, Integer total_pinjam, Integer total_denda, Petugas petugas) {
