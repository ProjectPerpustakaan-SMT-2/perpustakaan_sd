 ...
 */
public class PopupViewDataDiubah extends javax.swing.JFrame {

    /**
     * Creates new form PopupViewLogin
     */
    public PopupViewDataDiubah() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(615, 467, 135, 45);

        background.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Data berhasil diubah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewDataDiubah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
