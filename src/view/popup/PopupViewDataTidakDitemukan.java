 ...
 */
public class PopupViewDataTidakDitemukan extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewDataTidakDitemukan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
