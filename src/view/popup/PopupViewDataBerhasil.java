 ...
 */
public class PopupViewDataBerhasil extends javax.swing.JFrame {

    /**
     * Creates new form PopupViewLogin
     */
    public PopupViewDataBerhasil() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(615, 480, 135, 50);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Data berhasil ditambahkan.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewDataBerhasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
