 ...
 */
public class PopupViewKodeOTPTidakCocok extends javax.swing.JFrame {

    /**
     * Creates new form PopupViewLogin
     */
    public PopupViewKodeOTPTidakCocok() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewKodeOTPTidakCocok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
