 ...
 */
public class PopupViewDataPasswordTidakSama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(189, 245, 120, 40);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Password dan Konfirmasi Password Harus Sama! (Phone).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewDataPasswordTidakSama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
