 ...
 */
public class PopupViewDataGagal extends javax.swing.JFrame {

    /**
     * Creates new form PopupViewLogin
     */
    public PopupViewDataGagal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(605, 467, 155, 45);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Data Gagal ditambahkan.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewDataGagal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
