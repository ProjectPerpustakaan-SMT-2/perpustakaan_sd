 ...
 */
public class PopupViewHapusData extends javax.swing.JFrame {

    /**
     * Creates new form PopupViewLogin
     */
    public PopupViewHapusData() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(618, 467, 130, 45);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Data terhapus.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewHapusData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
