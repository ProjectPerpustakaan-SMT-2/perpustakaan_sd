 ...
 */
public class PopupViewKodeOTPTerkirim extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnOke.setBounds(190, 228, 120, 40);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/popup/Code OTP Berhasil Terkirim! (Phone).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupViewKodeOTPTerkirim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
