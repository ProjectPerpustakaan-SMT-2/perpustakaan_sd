 ...
 */
public class VerifikasiPeminjaman extends javax.swing.JInternalFrame {

    private String username;

    private TransaksiSiswa transaksi;
    private DetailTransaksiSiswa detailTransaksi;
    ...
    private List<DetailTransaksiSiswa> details, deleteDetails = new ArrayList<>();
     ...
     */
    public VerifikasiPeminjaman(TransaksiSiswa transaksi) {
    ...
    private void btnTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTambahMouseClicked
        ...
        Date tglPinjam = tKembali.getDate();
        Date tglKembali = tKembali.getDate();
        int jumlah = 1;
        int denda = 0;

        detail.setKode_buku(buku);
        detail.setTgl_pinjam(tglPinjam);
